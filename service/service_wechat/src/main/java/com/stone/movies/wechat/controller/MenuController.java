package com.stone.movies.wechat.controller;
...
import com.stone.movies.wechat.service.MenuService;
import com.stone.movies.wechat.utils.ConstantPropertiesUtil;
import com.stone.movies.wechat.utils.HttpClientUtils;
...
public class MenuController {
    ...
    public Result getAccessToken() {
        try {
            ...
            e.printStackTrace();
            throw new StoneException(20001,"获取access_token失败");
        }
    }
